...
export const getInputClassNames = ({
  ...
  classNames(
    "w-full ps-10 px-3 border text-neutral-5 enabled:shadow-xsm enabled:focus:ring-2 enabled:focus:ring-offset-2 enabled:focus:ring-neutral-80 disabled:opacity-60 outline-none pe-10",
    {
      ...
      "border-neutral-70": !(touched && error && variant === "outline"),
      "bg-neutral-100 enabled:hover:bg-neutral-80 enabled:hover:border-neutral-100":
        variant === "outline",
      "bg-neutral-80 enabled:hover:bg-neutral-100 enabled:hover:border-neutral-70":
        variant === "filled",
