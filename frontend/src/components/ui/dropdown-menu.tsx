...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "prose-b2-regular flex gap-2 items-center p-2 mx-2 rounded-lg hover:bg-neutral-90 cursor-pointer outline-none ",
      className,
    )}
    {...props}
  >
    {children}
    <RiArrowRightSLine size={20} className="text-neutral-40 ml-auto" />
  </DropdownMenuPrimitive.SubTrigger>
));
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-4 py-1 bg-neutral-80 prose-c2-semibold text-neutral-20",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cn("border-b border-neutral-70", className)}
    {...props}
  />
));
